...
extern "C" {
#endif
void  rmaPropagate4_p_simv_axi_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_simv_axi_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_f_simv_axi_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate4_r_simv_axi_daidir (UB  * pcode);
void  rmaPropagate4_wn_simv_axi_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_p_simv_axi_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_simv_axi_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_f_simv_axi_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate5_r_simv_axi_daidir (UB  * pcode);
void  rmaPropagate5_wn_simv_axi_daidir (UB  * pcode, scalar  val);
